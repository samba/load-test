...
do_exec() {
  ...
  echo "Will run $LOCUST_FILE against $TARGET_HOST. Spawning $CLIENTS clients and $RUNTIME total runtime."
...
Options:
  ...
  -t  Run time of the load test e.g. 1m, 17h, 5d (default 300s)
